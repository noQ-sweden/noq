...
import {
  BookingPageDTO,
  BookingReqBody,
} from "@/components/booking/BookingPageDTO";
import Button1 from "@/libs/Button1";
import { useRouter } from "next/navigation";
import {
  fetchPage,
  fetchSendHostRequest,
} from "@/components/booking/BookingPageAPI";
...
const BookingPage = (props: BookingProps) => {
  ...
  const onClickSendHostRequest = (userId: string, hostId: string) => {
    ...
    fetchSendHostRequest(reqBody).finally(() =>
          ...
          <div className={"flex flex-col w-11/12 gap-1"}>
            ...
            <section className="mt-4">
              <Button1
                ...
                isLoading={false}
                onClick={() =>
                  onClickSendHostRequest(
                    bookingPageDTO.userId,
                    bookingPageDTO.hostId
                  )
                }
              />
            </section>
